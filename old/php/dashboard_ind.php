...
?>
    ...
    <body>
        ...
        <section class="content">
            <div class="row">
                ...
                <h2> <?php echo stripslashes($individual['ind_firstname']." ".$individual['ind_lastname']."'s"); ?> Account Manager</h2>
                <h3> Important Notes! </h3>
                <ul id="notes"> 
                    <li><i class="fa fa-exclamation-circle"></i>  The deadline for Priority Registrations is <b>September 30th</b>. All payments must be made in full before that date for countries and committees to be assigned. For a full list of all fees and dates, please click <a href="fees.php">here</a>. </li>
                    <li><i class="fa fa-exclamation-circle"></i>  Remember to submit your committee preferences <a href="dash_committees.php">here</a>. </li>
                    <li><i class="fa fa-exclamation-circle"></i>  Please review the individual delegate liability form <a href="./assets/indi-agreement-full.pdf">here</a> and email a signed copy of the form to <a href="mailto:recruitment@ilmunc-india.com">recruitment@ilmunc-india.com</a>.</li> 
                ...
                <table> 
                    <tr>
                        <th> Name </th>
                        <td> 
                            <span id="first_name"> <?php echo stripslashes($individual['ind_firstname']); ?> </span>
                            <span id="last_name"> <?php echo stripslashes($individual['ind_lastname']); ?> </span>
                            <form id="name-form" method="post" action="ajax/update_ind_name.php">
                        ...
                        <td class="button-td"> 
                            <a class="edit button tiny" data-target-form="name-form" data-target-info="first_name last_name"> Edit </a>
                            <a class="button tiny hidden submit" data-target-form="name-form" data-target-button="name-form-submit"> Submit </a>
                        </td>
                    </tr>
                    <tr>
                        <th> Address </th>
                        <td> 
                             <span id="address-hide">
                                 <span id="istreet"><?php echo stripcslashes($individual['ind_add1']); ?></span><br>
                                 <span id="iarea"><?php echo stripcslashes($individual['ind_add2']); ?></span><br>
                                 <span id="icity"><?php echo stripcslashes($individual['ind_city']); ?></span>
                                 <span id="istate"><?php echo stripcslashes($individual['ind_state']); ?></span>
                                 <span id="izip"><?php echo $individual['ind_postalcode']; ?></span> <br> 
                                 <span id="icountry"><?php echo stripcslashes($individual['ind_country']); ?></span>
                                <!--<p> Will you be staying at the conference hotel? </p>
                                 <span id="country"> Yes </span>-->
                             </span>
                             <form id="address-form" method="post" action="ajax/update_ind_address.php">
                                 <input type="text" id="istreet" name="istreet" placeholder="Street" />
                                 <input type="text" id="iarea" name="iarea" placeholder="Area" />
                                 <input type="text" id="icity" name="icity" placeholder="City" />
                                 <input type="text" id="istate" name="istate" placeholder="State" />
                                 <input type="text" id="izip" name="izip" placeholder="Zip Code" />
                        ...
                        <td class="button-td"> 
                            <a class="edit button tiny" data-target-form="address-form" data-target-info="istreet iarea icity istate izip icountry address-hide"> Edit </a>
                    ...
                    <tr>
                        ...
                        <td> 
                            ...
                            <form id="school-form" method="post" action="ajax/update_name.php">
                                ...
                                <input type="hidden" id="school_id" name="school_id" <?php echo "value=\"".$school_id."\""; ?>>
                                <input type="submit" id="school-name-form-submit" style="visibility: hidden;" value="Submit" >
                            </form>
                        </td>
                        <td class="button-td"> 
                            <a class="edit button tiny" data-target-form="school-form" data-target-info="school_name"> Edit </a>
                            <a class="button tiny hidden submit" data-target-form="school-form" data-target-button="school-name-form-submit"> Submit </a>
                        </td>
                    </tr>
                    <tr>
                        <th> Address </th>
                        <td> 
                             <span id="address-hide-school">
                             ...
                             <form id="school-address-form" method="post" action="ajax/update_address.php">
                                 ...
                                 <input type="hidden" id="school_id" name="school_id" <?php echo "value=\"".$school_id."\""; ?>>
                                 <input type="submit" id="address-form-school-submit" style="visibility: hidden;" value="Submit" >
                             </form>
                        </td>
                        <td class="button-td"> 
                            <a class="edit button tiny" data-target-form="school-address-form" data-target-info="street area city state zip country address-hide-school"> Edit </a>
                            <a class="button tiny hidden submit" data-target-form="school-address-form" data-target-button="address-form-school-submit"> Submit </a>
                        </td>
                    </tr>
                </table>
                <?php
    ...
    while($stmt->fetch()) {
        ...
        $country_opt .= "<tr><td>".$countries["country_name"]."</td><td>".$countries['num_delegates']."</td></tr>";
    }
    ...
    $stmt->close();
    ?>
                <h3 class="text-center"> Assignment Summary </h3>
